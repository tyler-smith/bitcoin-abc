...
1. Clone the Bitcoin Cash source code and cd into `bitcoin-abc`

        git clone https://github.com/Bitcoin-ABC/bitcoin-abc.git
        cd bitcoin-abc

2.  Build Bitcoin Cash:

    Configure and build the headless Bitcoin Cash binaries as well as the GUI.
...
Bitcoin Cash is now available at `./src/bitcoind`
